...
(function(window, angular, undefined) {
    ...
    .factory('ssSideNav', [
        ...
        function(
            ...
            self = {
                ...
                toggleSelectSection: function(section) {
                    ...
                    // if(section.children) {
                    //     self.openedChildren = (self.openedChildren === section.children) ? null : section.children;
                    // }else {
                    //     if(self.openedChildren) {
                    //         angular.forEach(self.openedChildren, function (e, i) {
                    //             if(e === section) {
                    //                 self.openedSection = (self.openedSection === section) ? null : section;
                    //             }
                    //         })
                ...
                isChildrenSelected: function(children) {
                    return self.openedChildren === children;
                },
                toggleSelectChildren: function(children) {
                    self.openedChildren = (self.openedChildren === children) ? null : children;
                },
        ...
        .controller('menuHeadingToggleCtrl', [
            '$scope',
            '$state',
            'ssSideNav',
            function(
                ...
                $scope.isOpen = function(section) {
                    return ssSideNav.isChildrenSelected(section);
                };

                $scope.toggle = function(section) {
                    ssSideNav.toggleSelectChildren(section);
                };

                this.isOpen = $scope.isOpen;

                $scope.$on('SS_SIDENAV_FORCE_SELECTED_ITEM', function (event, args) {
                    if ($scope.section && $scope.section.children) {
                        for (var i = $scope.section.children.length - 1; i >= 0; i--) {
                            var _e = $scope.section.children[i];
        ...
        .directive('menuHeadingToggle', [
            ...
            function(
                ...
                return {
                    ...
                    templateUrl: 'views/ss/menu-heading-toggle.tmpl.html',
                    controller: 'menuHeadingToggleCtrl',
                    link: link
                };
            }
    ...
    .run(['$templateCache', function($templateCache) {
        ...
        $templateCache.put('views/ss/menu-toggle.tmpl.html',
            '<md-button class="md-raised md-warn md-button-toggle"\n' +
        ...
        $templateCache.put('views/ss/menu-heading-toggle.tmpl.html',
            '<md-button class="md-raised md-warn md-button-toggle"\n' +
            '   ng-click="toggle(section)"\n' +
            '   aria-controls="docs-menu-{{section.name}}"\n' +
            '   aria-expanded="{{isOpen(section)}}">\n' +
        ...
        $templateCache.put('views/ss/menu-sidenav.tmpl.html',
            ...
            '        <menu-heading-toggle section="section" ng-if="section.type === \'heading\'"></menu-heading-toggle>' +
